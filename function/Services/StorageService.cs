...
namespace AHI.Broker.Function.Service
{
    public class StorageService : IStorageService
    {
        ...
        public async Task DownloadFileToStreamAsync(string filePath, Stream destination)
        {
        ...
        {
            return _httpClientFactory.CreateClient(HttpClientNames.STORAGE, _tenantContext);
        }

        private HttpClient GetDownloadClient()
        {
            return _httpClientFactory.CreateClient(HttpClientNames.DOWNLOAD_CLIENT);
        }
