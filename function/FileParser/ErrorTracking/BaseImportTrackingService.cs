...
namespace AHI.Broker.Function.FileParser.ErrorTracking
{
    public abstract class BaseImportTrackingService : IImportTrackingService
    {
        ...
        public abstract void RegisterError(string message, TrackModel model, string propName, ErrorType errorType = ErrorType.UNDEFINED, IDictionary<string, object> validationInfo = null);
    }
}
