...
namespace Broker.Application.Event
{
    public class BrokerChangedEvent : BusEvent
    {
        ...
        public BrokerChangedEvent(Guid id, string name, string type, ITenantContext tenantContext, bool requestDeploy, ActionTypeEnum actionType = ActionTypeEnum.Updated)
        {
            Id = id;
            Name = name;
